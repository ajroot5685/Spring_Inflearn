...
class UserControllerTest {
    ...
    void 사용자는_존재하지_않는_유저의_아이디로_api_호출할_경우_404_응답을_받는다() throws Exception {
        ...
        // when
        // then
        mockMvc.perform(get("/api/users/11231232"))
                .andExpect(status().isNotFound())
                .andExpect(content().string("Users에서 ID 11231232를 찾을 수 없습니다."));   // 응답 내용이 json이 아닌 문자열인 경우 문자열 비교
    }
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/users/2/verify")
                .queryParam("certificationCode", "aaaaaaaa-aaaaaaa-aaaa-aaaaaaaaa-aaaaab"))
    ...
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다() throws Exception {
        ...
        // then
        mockMvc.perform(get("/api/users/2/verify")
                        .queryParam("certificationCode", "aaaaaaaa-aaaaaaa-aaaa-aaaaaaaaa-aaaaac"))
