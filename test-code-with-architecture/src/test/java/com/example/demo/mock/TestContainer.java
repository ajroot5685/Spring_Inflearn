...
public class TestContainer {
    ...
    public TestContainer(ClockHolder clockHolder, UuidHolder uuidHolder) {
        this.mailSender = new FakeMailSernder();
    ...
    public static TestContainer create() {
        return new TestContainer(new TestClockHolder(1678530673958L), new TestUuidHolder("aaaaaaaa-aaaaaaa-aaaa-aaaaaaaaa-aaaaaa"));
    }
}
